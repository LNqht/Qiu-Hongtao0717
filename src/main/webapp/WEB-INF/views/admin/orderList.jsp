			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.qiuhongtao.model.Order o=(com.qiuhongtao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.qiuhongtao.dao.UserDao userDao=new com.qiuhongtao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.qiuhongtao.model.Payment.findByPaymentId(con,n);
							 %>
